  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-400 mt-0.5">{CONVENIOS.length} convenios en total</p>
      </div>
            ...
            {CONVENIOS.map(c => (
              <tr key={c.id} className="hover:bg-gray-50/50 transition-colors">
                ...
                <td className="px-4 py-3">
                  <span className="text-[11.5px] font-semibold text-gray-600">{c.organismo}</span>
                </td>
                <td className="px-4 py-3">
                ...
                <td className="px-4 py-3 text-gray-400 text-[12px]">{formatFecha(c.vencimiento)}</td>
