...
import { MAILS_INTA } from '@/lib/mock-data'
import { formatFecha } from '@/lib/utils'

export default function Mails() {
  const noLeidos = MAILS_INTA.filter(m => !m.leido).length
    ...
    <div className="p-6">
      <div className="mb-6">
        <p className="text-[11px] text-gray-400 mb-0.5">
          ...
          <Link href="/mi-organismo" className="hover:underline">Mi Organismo</Link> / Mails
        </p>
        ...
        <p className="text-sm text-gray-400 mt-0.5">{MAILS_INTA.length} mensajes</p>
      </div>
